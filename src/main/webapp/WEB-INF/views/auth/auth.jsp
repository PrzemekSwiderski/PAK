...
<div class="auth-page">
    ...
    <div class="reg-auth-forms">
        ...
        <form method="post" action='<c:url value="/register"/>' class="registration" id="form-register" hidden="hidden" >
            <div class="form-group mt-3">
                <label for="log-mail">Email</label>
            ...
            <div class="form-group mt-3">
                ...
                <input type="text" class="form-control" name="imageAddress" id="reg-image-address"
                       placeholder="Adres do twojego zdjęcia"
                       required>
            </div>
            <br>
            <div class="text-center">
